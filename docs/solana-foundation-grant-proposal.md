...
| Claim | Evidence |
|---|---|
| Correctness | 984 tests / 0 failures / 0 clippy / 0 warnings; benchmark 100% precision & recall on 16 scored cases |
...
- **What remains is not research risk — it is delivery cost.** The core is built and
  tested (984 tests, two audits, live RPC validation). The remaining work — deployment,
