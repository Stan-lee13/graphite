...
| Test expansion | 85% | **88%** | 984 tests incl. concurrency storm, hostile-body battery, registry caps, ALT regression | High | Keep |
...
- **Docs-vs-reality synced:** README/ARCHITECTURE/ROADMAP/release-evaluation/phase2-plan/branch-strategy/gap-audit updated to 984 tests / 22 manifests / 561 instructions / 11 risk patterns (were 844/15/216/8).
