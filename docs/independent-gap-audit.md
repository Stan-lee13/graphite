...
| Test expansion | 85% | **88%** | 1012 tests incl. concurrency storm, hostile-body battery, registry caps, ALT regression | High | Keep |
| Live corpus collection | 75% | **75%** | seed-live on live devnet works; corpus dedupe + fail-closed load | High | Keep |
| Protocol expansion | 4/15–20 target | **8/15–20** (22 total manifests; Tier-0 + Tier-1 complete (Drift+Kamino C27/C42) — ATA, Compute Budget, BPF Loader, BPF Loader Upgradeable added C17) | 28 manifests on-chain verified; Tier-1 (Drift+Kamino) built C27/C42; Pyth remains for future expansion | High | **Build Tier-1 next** |
...
- **Docs-vs-reality synced:** README/ARCHITECTURE/ROADMAP/release-evaluation/phase2-plan/branch-strategy/gap-audit updated to 1012 tests / 28 manifests / 695 instructions / 11 risk patterns (were 844/15/216/8).
...
- **Protocol diversity:** 28 manifests (incl. classic SPL memo C16 + Tier-0 ATA/Compute Budget/BPF Loaders C17 + Tier-1 Drift+Kamino C27/C42); Pyth remains for future expansion.
