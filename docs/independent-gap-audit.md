...
| Test expansion | 85% | **88%** | 987 tests incl. concurrency storm, hostile-body battery, registry caps, ALT regression | High | Keep |
...
- **Docs-vs-reality synced:** README/ARCHITECTURE/ROADMAP/release-evaluation/phase2-plan/branch-strategy/gap-audit updated to 987 tests / 28 manifests / 695 instructions / 11 risk patterns (were 844/15/216/8).
