...
| Test expansion | 85% | **88%** | 861 tests incl. concurrency storm, hostile-body battery, registry caps, ALT regression | High | Keep |
...
- **Docs-vs-reality synced:** README/ARCHITECTURE/ROADMAP/release-evaluation/phase2-plan/branch-strategy/gap-audit updated to 861 tests / 20 manifests / 219 instructions / 9 risk patterns (were 844/15/216/8).
...
- **Protocol diversity:** 20 manifests (incl. classic SPL memo C16 + Tier-0 ATA/Compute Budget/BPF Loaders C17); Tier-0 complete; Tier-1 (Kamino/Drift/Pyth) missing.
