...
fn test_adv_legit_look_022() {
    ...
    println!(
        "Legit-look 022 (JUPITER_V6) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_adv_legit_look_027() {
    ...
    println!(
        "Legit-look 027 (JUPITER_V6) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_adv_account_gaming_031() {
    ...
    println!(
        "Account gaming 031 (3 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(
        result.risk_verdict.status == "Clear",
        "3 accounts with Transfer should be clear"
    );
}
...
fn test_adv_account_gaming_032() {
    ...
    println!(
        "Account gaming 032 (4 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(
        result.risk_verdict.status == "Clear",
        "4 accounts with Transfer should be clear"
    );
}
...
fn test_adv_account_gaming_033() {
    ...
    println!(
        "Account gaming 033 (5 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(
        result.risk_verdict.status == "Clear",
        "5 accounts with Transfer should be clear"
    );
}
...
fn test_adv_account_gaming_034() {
    ...
    println!(
        "Account gaming 034 (6 accts) — risk: {}",
        result.risk_verdict.status
    );
...
fn test_adv_account_gaming_035() {
    ...
    println!(
        "Account gaming 035 (7 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(result.risk_verdict.status == "Blocked");
}
...
fn test_adv_account_gaming_036() {
    ...
    println!(
        "Account gaming 036 (8 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(result.risk_verdict.status == "Blocked");
}
...
fn test_adv_account_gaming_037() {
    ...
    println!(
        "Account gaming 037 (9 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(result.risk_verdict.status == "Blocked");
}
...
fn test_adv_account_gaming_038() {
    ...
    println!(
        "Account gaming 038 (10 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(result.risk_verdict.status == "Blocked");
}
...
fn test_adv_account_gaming_039() {
    ...
    println!(
        "Account gaming 039 (11 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(result.risk_verdict.status == "Blocked");
}
...
fn test_adv_account_gaming_040() {
    ...
    println!(
        "Account gaming 040 (12 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(result.risk_verdict.status == "Blocked");
}
...
fn test_adv_prog_confusion_061() {
    ...
    println!(
        "Prog confusion 061 — conf: {}, unknown: {}",
...
fn test_adv_prog_confusion_062() {
    ...
    println!(
        "Prog confusion 062 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_adv_prog_confusion_063() {
    ...
    println!(
        "Prog confusion 063 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_adv_prog_confusion_064() {
    ...
    println!(
        "Prog confusion 064 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_adv_prog_confusion_065() {
    ...
    println!(
        "Prog confusion 065 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_adv_prog_confusion_066() {
    ...
    println!(
        "Prog confusion 066 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_adv_prog_confusion_067() {
    ...
    println!(
        "Prog confusion 067 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_adv_prog_confusion_068() {
    ...
    println!(
        "Prog confusion 068 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_adv_prog_confusion_069() {
    ...
    println!(
        "Prog confusion 069 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_adv_prog_confusion_070() {
    ...
    println!(
        "Prog confusion 070 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_adv_mixed_signal_081() {
    ...
    println!(
        "Mixed signal 081 — approved: {}, conf: {}",
...
fn test_adv_mixed_signal_082() {
    ...
    println!(
        "Mixed signal 082 — approved: {}, conf: {}",
        result.approved, result.confidence
    );
    assert!(!result.approved);
}
...
fn test_adv_mixed_signal_083() {
    ...
    println!(
        "Mixed signal 083 — approved: {}, conf: {}",
        result.approved, result.confidence
    );
...
fn test_adv_mixed_signal_084() {
    ...
    println!(
        "Mixed signal 084 — approved: {}, conf: {}",
        result.approved, result.confidence
    );
    assert!(!result.approved);
}
...
fn test_adv_mixed_signal_085() {
    ...
    println!(
        "Mixed signal 085 — approved: {}, conf: {}",
        result.approved, result.confidence
    );
...
fn test_adv_mixed_signal_086() {
    ...
    println!(
        "Mixed signal 086 — approved: {}, conf: {}",
        result.approved, result.confidence
    );
    assert!(!result.approved);
}
...
fn test_adv_mixed_signal_087() {
    ...
    println!(
        "Mixed signal 087 — approved: {}, conf: {}",
        result.approved, result.confidence
    );
...
fn test_adv_mixed_signal_088() {
    ...
    println!(
        "Mixed signal 088 — approved: {}, conf: {}",
        result.approved, result.confidence
    );
    assert!(!result.approved);
}
...
fn test_adv_mixed_signal_089() {
    ...
    println!(
        "Mixed signal 089 — approved: {}, conf: {}",
        result.approved, result.confidence
    );
...
fn test_adv_mixed_signal_090() {
    ...
    println!(
        "Mixed signal 090 — approved: {}, conf: {}",
        result.approved, result.confidence
    );
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_091() {
    ...
    println!(
        "Full evasion 091 (SPL_TOKEN, TradingBot) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_092() {
    ...
    println!(
        "Full evasion 092 (JUPITER_V6, Gaming) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_093() {
    ...
    println!(
        "Full evasion 093 (SYSTEM, Enterprise) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_094() {
    ...
    println!(
        "Full evasion 094 (RAYDIUM, TradingBot) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_095() {
    ...
    println!(
        "Full evasion 095 (ORCA, Treasury) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_096() {
    ...
    println!(
        "Full evasion 096 (SPL_TOKEN, TradingBot) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_097() {
    ...
    println!(
        "Full evasion 097 (JUPITER_V6, Gaming) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_098() {
    ...
    println!(
        "Full evasion 098 (SYSTEM, Enterprise) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_099() {
    ...
    println!(
        "Full evasion 099 (RAYDIUM, TradingBot) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_100() {
    ...
    println!(
        "Full evasion 100 (ORCA, Treasury) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
