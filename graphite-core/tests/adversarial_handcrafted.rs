...
fn test_adv_trust_max_001() {
    let result = run(make_ev(SPL_TOKEN, "09", &[A1, A2, A3], &[], WalletProfile::Gaming, BehaviorEvidence { has_signed_manifest: true, community_verified_count: 100, battle_tested_tx_count: 1000000, simulation_match_count: 1000 }));
...
fn test_adv_trust_max_007() {
    let result = run(make_ev(TOKEN_2022, "09", &[A1, A2, A3], &[], WalletProfile::Gaming, BehaviorEvidence { has_signed_manifest: true, community_verified_count: 100, battle_tested_tx_count: 1000000, simulation_match_count: 1000 }));
...
fn test_adv_profile_011() {
    let result = run(make(SPL_TOKEN, "03", &[A1, A2, A3], &[A4], WalletProfile::Gaming));
...
fn test_adv_profile_013() {
    let result = run(make(SPL_TOKEN, "09", &[A1, A2, A3], &[A4], WalletProfile::Gaming));
...
fn test_adv_legit_look_021() {
    let result = run(make(SPL_TOKEN, "03", &[A1, A2, A3], &[A1], WalletProfile::TradingBot));
...
fn test_adv_legit_look_022() {
    let result = run(make(JUPITER_V6, "03", &[A1, A2, A3], &[A1], WalletProfile::TradingBot));
...
fn test_adv_legit_look_023() {
    let result = run(make(RAYDIUM, "03", &[A1, A2, A3], &[A1], WalletProfile::TradingBot));
...
fn test_adv_legit_look_024() {
    let result = run(make(ORCA, "03", &[A1, A2, A3], &[A1], WalletProfile::TradingBot));
...
fn test_adv_legit_look_025() {
    let result = run(make(METEORA, "03", &[A1, A2, A3], &[A1], WalletProfile::TradingBot));
...
fn test_adv_cpi_obfuscation_042() {
    let result = run(make(JUPITER_V6, "03", &[A1, A2, A3], &[A1, A2], WalletProfile::TradingBot));
...
fn test_adv_cpi_obfuscation_043() {
    let result = run(make(SYSTEM, "03", &[A1, A2, A3], &[A1, A2, A3], WalletProfile::TradingBot));
...
fn test_adv_cpi_obfuscation_044() {
    let result = run(make(RAYDIUM, "03", &[A1, A2, A3], &[A1, A2, A3, A4], WalletProfile::TradingBot));
...
fn test_adv_cpi_obfuscation_045() {
    let result = run(make(SQUADS, "03", &[A1, A2, A3], &[A1, A2, A3, A4, A5], WalletProfile::TradingBot));
...
fn test_adv_prog_confusion_061() {
    let result = run(make(A1, "02000000", &[A1, A2, A3], &[], WalletProfile::TradingBot));
...
fn test_adv_prog_confusion_062() {
    let result = run(make(A2, "02000000", &[A1, A2, A3], &[], WalletProfile::TradingBot));
...
fn test_adv_prog_confusion_063() {
    let result = run(make(U2, "02000000", &[A1, A2, A3], &[], WalletProfile::TradingBot));
...
fn test_adv_full_evasion_091() {
    let result = run(make(SPL_TOKEN, "03", &[A1, A2, A3], &[A1], WalletProfile::TradingBot));
    println!("Full evasion 091 (SPL_TOKEN, TradingBot) — approved: {}", result.approved);
    assert!(!result.approved);
}

#[test]
fn test_adv_full_evasion_092() {
    let result = run(make(JUPITER_V6, "03", &[A1, A2, A3], &[A1], WalletProfile::Gaming));
    println!("Full evasion 092 (JUPITER_V6, Gaming) — approved: {}", result.approved);
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_094() {
    let result = run(make(RAYDIUM, "03", &[A1, A2, A3], &[A1], WalletProfile::TradingBot));
    println!("Full evasion 094 (RAYDIUM, TradingBot) — approved: {}", result.approved);
    assert!(!result.approved);
}

#[test]
fn test_adv_full_evasion_095() {
    let result = run(make(ORCA, "03", &[A1, A2, A3], &[A1], WalletProfile::Treasury));
    println!("Full evasion 095 (ORCA, Treasury) — approved: {}", result.approved);
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_096() {
    let result = run(make(SPL_TOKEN, "03", &[A1, A2, A3], &[A1], WalletProfile::TradingBot));
    println!("Full evasion 096 (SPL_TOKEN, TradingBot) — approved: {}", result.approved);
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_097() {
    let result = run(make(JUPITER_V6, "03", &[A1, A2, A3], &[A1], WalletProfile::Gaming));
    println!("Full evasion 097 (JUPITER_V6, Gaming) — approved: {}", result.approved);
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_099() {
    let result = run(make(RAYDIUM, "03", &[A1, A2, A3], &[A1], WalletProfile::TradingBot));
    println!("Full evasion 099 (RAYDIUM, TradingBot) — approved: {}", result.approved);
    assert!(!result.approved);
}
...
fn test_adv_full_evasion_100() {
    let result = run(make(ORCA, "03", &[A1, A2, A3], &[A1], WalletProfile::Treasury));
    println!("Full evasion 100 (ORCA, Treasury) — approved: {}", result.approved);
    assert!(!result.approved);
}
