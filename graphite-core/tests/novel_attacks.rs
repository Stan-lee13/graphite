...
// addresses. These cases are about account-count boundaries, not about who the
// counterparty is, but the filler made them assert that a token transfer whose
// authority is the Token Program is Clear. No key exists for a program address,
// so it can neither sign as an authority nor spend what it receives, and
// `UnspendableDestination` blocks exactly that (2026-09-08). Ordinary valid
// pubkeys restore the property these cases were written to test.
...
fn test_novel_trust_manip_021() {
    let result = run(make_ev(
        ...
        BehaviorEvidence {
            ...
            battle_tested_tx_count: 1000000,
...
fn test_novel_graph_poison_051() {
    let result = run(make_ev(
        ...
        BehaviorEvidence {
            has_signed_manifest: true,
            community_verified_count: 510,
            battle_tested_tx_count: 51000,
            simulation_match_count: 510,
        },
    ));
...
fn test_novel_graph_poison_052() {
    let result = run(make_ev(
        ...
        BehaviorEvidence {
            has_signed_manifest: true,
            community_verified_count: 520,
            battle_tested_tx_count: 52000,
            simulation_match_count: 520,
        },
    ));
...
fn test_novel_graph_poison_053() {
    let result = run(make_ev(
        ...
        BehaviorEvidence {
            has_signed_manifest: true,
            community_verified_count: 530,
            battle_tested_tx_count: 53000,
            simulation_match_count: 530,
        },
    ));
...
fn test_novel_graph_poison_054() {
    let result = run(make_ev(
        ...
        BehaviorEvidence {
            has_signed_manifest: true,
            community_verified_count: 540,
            battle_tested_tx_count: 54000,
            simulation_match_count: 540,
        },
    ));
...
fn test_novel_graph_poison_055() {
    let result = run(make_ev(
        ...
        BehaviorEvidence {
            has_signed_manifest: true,
            community_verified_count: 550,
            battle_tested_tx_count: 55000,
            simulation_match_count: 550,
        },
    ));
...
fn test_novel_graph_poison_056() {
    let result = run(make_ev(
        ...
        BehaviorEvidence {
            has_signed_manifest: true,
            community_verified_count: 560,
            battle_tested_tx_count: 56000,
            simulation_match_count: 560,
        },
    ));
...
fn test_novel_graph_poison_057() {
    let result = run(make_ev(
        ...
        BehaviorEvidence {
            has_signed_manifest: true,
            community_verified_count: 570,
            battle_tested_tx_count: 57000,
            simulation_match_count: 570,
        },
    ));
...
fn test_novel_graph_poison_058() {
    let result = run(make_ev(
        ...
        BehaviorEvidence {
            has_signed_manifest: true,
            community_verified_count: 580,
            battle_tested_tx_count: 58000,
            simulation_match_count: 580,
        },
    ));
...
fn test_novel_graph_poison_059() {
    let result = run(make_ev(
        ...
        BehaviorEvidence {
            has_signed_manifest: true,
            community_verified_count: 590,
            battle_tested_tx_count: 59000,
            simulation_match_count: 590,
        },
    ));
...
fn test_novel_graph_poison_060() {
    let result = run(make_ev(
        ...
        BehaviorEvidence {
            has_signed_manifest: true,
            community_verified_count: 600,
            battle_tested_tx_count: 60000,
            simulation_match_count: 600,
        },
    ));
...
fn test_novel_manifest_confusion_061() {
    ...
    println!(
        "Manifest confusion 061 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_novel_manifest_confusion_062() {
    ...
    println!(
        "Manifest confusion 062 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_novel_manifest_confusion_063() {
    ...
    println!(
        "Manifest confusion 063 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_novel_manifest_confusion_064() {
    ...
    println!(
        "Manifest confusion 064 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_novel_manifest_confusion_065() {
    ...
    println!(
        "Manifest confusion 065 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_novel_manifest_confusion_066() {
    ...
    println!(
        "Manifest confusion 066 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_novel_manifest_confusion_067() {
    ...
    println!(
        "Manifest confusion 067 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_novel_manifest_confusion_068() {
    ...
    println!(
        "Manifest confusion 068 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_novel_manifest_confusion_069() {
    ...
    println!(
        "Manifest confusion 069 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_novel_manifest_confusion_070() {
    ...
    println!(
        "Manifest confusion 070 — conf: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(result.confidence <= 0.55);
}
...
fn test_novel_instruction_data_071() {
    ...
    println!(
        "Instruction data 071 (disc=03) — approved: {}",
        result.approved
    );
    assert!(
        !result.approved,
        "novel disc 03 on unknown program should not be approved"
    );
}
...
fn test_novel_instruction_data_072() {
    ...
    println!(
        "Instruction data 072 (disc=0c) — approved: {}",
        result.approved
    );
...
fn test_novel_instruction_data_073() {
    ...
    println!(
        "Instruction data 073 (disc=0b) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_novel_instruction_data_074() {
    ...
    println!(
        "Instruction data 074 (disc=09) — approved: {}",
        result.approved
    );
    assert!(!result.approved);
}
...
fn test_novel_instruction_data_075() {
    ...
    println!(
        "Instruction data 075 (disc=07) — approved: {}",
        result.approved
    );
...
fn test_novel_instruction_data_076() {
    ...
    println!(
        "Instruction data 076 (disc=08) — approved: {}",
        result.approved
    );
...
fn test_novel_instruction_data_077() {
    ...
    println!(
        "Instruction data 077 (disc=04) — approved: {}",
        result.approved
    );
...
fn test_novel_instruction_data_078() {
    ...
    println!(
        "Instruction data 078 (disc=02) — approved: {}",
        result.approved
    );
...
fn test_novel_instruction_data_079() {
    ...
    println!(
        "Instruction data 079 (disc=02000000) — approved: {}",
        result.approved
    );
    assert!(
        !result.approved,
        "novel disc 02000000 should not be approved"
    );
}
...
fn test_novel_instruction_data_080() {
    ...
    println!(
        "Instruction data 080 (disc=a1b2c3d4) — approved: {}",
        result.approved
    );
    assert!(
        !result.approved,
        "novel disc a1b2c3d4 should not be approved"
    );
}
...
fn test_novel_boundary_081() {
    ...
    println!(
        "Boundary 081 (2 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(
        result.risk_verdict.status == "Clear",
        "Boundary 081: 2 accounts with Transfer should be clear"
    );
}
...
fn test_novel_boundary_082() {
    ...
    println!(
        "Boundary 082 (3 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(
        result.risk_verdict.status == "Clear",
        "Boundary 082: 3 accounts with Transfer should be clear"
    );
}
...
fn test_novel_boundary_083() {
    ...
    println!(
        "Boundary 083 (4 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(
        result.risk_verdict.status == "Clear",
        "Boundary 083: 4 accounts with Transfer should be clear"
    );
}
...
fn test_novel_boundary_084() {
    ...
    println!(
        "Boundary 084 (5 accts) — risk: {}",
        result.risk_verdict.status
    );
    assert!(
        result.risk_verdict.status == "Clear",
        "Boundary 084: 5 accounts with Transfer should be clear"
    );
}
...
fn test_novel_comp_evasion_091() {
    ...
    println!(
        "Comp evasion 091 — approved: {}, risk: {}",
...
fn test_novel_comp_evasion_092() {
    ...
    println!(
        "Comp evasion 092 — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
...
fn test_novel_comp_evasion_093() {
    ...
    println!(
        "Comp evasion 093 — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
...
fn test_novel_comp_evasion_094() {
    ...
    println!(
        "Comp evasion 094 — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved);
}
...
fn test_novel_comp_evasion_095() {
    ...
    println!(
        "Comp evasion 095 — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
...
fn test_novel_comp_evasion_096() {
    ...
    println!(
        "Comp evasion 096 — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
...
fn test_novel_comp_evasion_097() {
    ...
    println!(
        "Comp evasion 097 — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved);
}
...
fn test_novel_comp_evasion_098() {
    ...
    println!(
        "Comp evasion 098 — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
...
fn test_novel_comp_evasion_099() {
    ...
    println!(
        "Comp evasion 099 — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
...
fn test_novel_comp_evasion_100() {
    ...
    println!(
        "Comp evasion 100 — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved);
}
