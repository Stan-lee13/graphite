...
const A8: &str = "whirLbMiicVdio4qvUfM5KAg6Ct8VwpYzGff3uctyCc";
const A9: &str = "LBUZKhRxPF3XUpBCjp4YzTKgLccjZhTSDM9YuVaPwxo";
...
fn test_real_stmt_001() {
    ...
    println!(
        "STMT 001 (4 accounts) — approved: {}, confidence: {}, risk: {}",
    ...
    assert!(
        !result.approved,
        "STMT 001: account count mismatch should not be approved"
    );
    assert!(
        result.confidence < 0.80,
        "STMT 001: account mismatch should keep confidence below TradingBot threshold"
    );
}
...
fn test_real_stmt_002() {
    ...
    let result = run(input);
    println!(
        "STMT 002 (5 accounts) — approved: {}, confidence: {}, risk: {}",
        result.approved, result.confidence, result.risk_verdict.status
    );
    ...
    assert!(
        !result.approved,
        "STMT 002: account count mismatch should not be approved"
    );
    assert!(
        result.confidence < 0.80,
        "STMT 002: account mismatch should keep confidence below TradingBot threshold"
    );
}
...
fn test_real_stmt_003() {
    ...
    let result = run(input);
    println!(
        "STMT 003 (6 accounts) — approved: {}, confidence: {}, risk: {}",
        result.approved, result.confidence, result.risk_verdict.status
    );
    assert!(
...
fn test_real_stmt_004() {
    ...
    let result = run(input);
    println!(
        "STMT 004 (7 accounts) — approved: {}, confidence: {}, risk: {}",
        result.approved, result.confidence, result.risk_verdict.status
    );
    assert!(
        !result.approved || result.confidence < 0.6,
...
fn test_real_stmt_005() {
    ...
    let result = run(input);
    println!(
        "STMT 005 (8 accounts) — approved: {}, confidence: {}, risk: {}",
        result.approved, result.confidence, result.risk_verdict.status
    );
    assert!(
        !result.approved || result.confidence < 0.6,
...
fn test_real_stmt_006() {
    ...
    let result = run(input);
    println!(
        "STMT 006 (9 accounts) — approved: {}, confidence: {}, risk: {}",
        result.approved, result.confidence, result.risk_verdict.status
    );
    assert!(
        !result.approved || result.confidence < 0.6,
...
fn test_real_stmt_007() {
    ...
    let result = run(input);
    println!(
        "STMT 007 (10 accounts) — approved: {}, confidence: {}, risk: {}",
        result.approved, result.confidence, result.risk_verdict.status
    );
    assert!(
        !result.approved || result.confidence < 0.6,
...
fn test_real_stmt_008() {
    ...
    let result = run(input);
    println!(
        "STMT 008 (11 accounts) — approved: {}, confidence: {}, risk: {}",
        result.approved, result.confidence, result.risk_verdict.status
    );
    assert!(
        !result.approved || result.confidence < 0.6,
...
fn test_real_stmt_009() {
    ...
    let result = run(input);
    println!(
        "STMT 009 (12 accounts) — approved: {}, confidence: {}, risk: {}",
        result.approved, result.confidence, result.risk_verdict.status
    );
    assert!(
        !result.approved || result.confidence < 0.6,
...
fn test_real_stmt_010() {
    ...
    let result = run(input);
    println!(
        "STMT 010 (13 accounts) — approved: {}, confidence: {}, risk: {}",
        result.approved, result.confidence, result.risk_verdict.status
    );
    assert!(
        !result.approved || result.confidence < 0.6,
...
fn test_real_aat_011() {
    ...
    let result = run(input);
    println!(
        "AAT 011 (SPL_TOKEN) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
        "SetAuthority MUST be blocked on {}",
        SPL_TOKEN
    );
}
...
fn test_real_aat_012() {
    ...
    let result = run(input);
    println!(
        "AAT 012 (TOKEN_2022) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_aat_013() {
    ...
    let result = run(input);
    println!(
        "AAT 013 (SPL_TOKEN) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_aat_014() {
    ...
    let result = run(input);
    println!(
        "AAT 014 (TOKEN_2022) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_aat_015() {
    ...
    let result = run(input);
    println!(
        "AAT 015 (SPL_TOKEN) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_aat_016() {
    ...
    let result = run(input);
    println!(
        "AAT 016 (TOKEN_2022) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_aat_017() {
    ...
    let result = run(input);
    println!(
        "AAT 017 (SPL_TOKEN) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_aat_018() {
    ...
    let result = run(input);
    println!(
        "AAT 018 (TOKEN_2022) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_aat_019() {
    ...
    let result = run(input);
    println!(
        "AAT 019 (SPL_TOKEN) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_aat_020() {
    ...
    let result = run(input);
    println!(
        "AAT 020 (TOKEN_2022) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_isa_021() {
    ...
    let result = run(input);
    println!(
        "ISA 021 (prog=A1) — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
        "Unknown program must be capped at 0.55"
    );
}
...
fn test_real_isa_022() {
    ...
    let result = run(input);
    println!(
        "ISA 022 (prog=A2) — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_isa_023() {
    ...
    let result = run(input);
    println!(
        "ISA 023 (prog=A3) — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_isa_024() {
    ...
    let result = run(input);
    println!(
        "ISA 024 (prog=A4) — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_isa_025() {
    ...
    let result = run(input);
    println!(
        "ISA 025 (prog=A5) — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_isa_026() {
    ...
    let result = run(input);
    println!(
        "ISA 026 (prog=A6) — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_isa_027() {
    ...
    let result = run(input);
    println!(
        "ISA 027 (prog=A7) — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_isa_028() {
    ...
    let result = run(input);
    println!(
        "ISA 028 (prog=A8) — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_isa_029() {
    ...
    let result = run(input);
    println!(
        "ISA 029 (prog=A9) — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_isa_030() {
    ...
    let result = run(input);
    println!(
        "ISA 030 (prog=A10) — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_compositional_031() {
    ...
    let result = run(input);
    println!(
        "Comp drain 031 (5 accts + CPI) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
...
fn test_real_compositional_032() {
    ...
    let result = run(input);
    println!(
        "Comp drain 032 (6 accts + CPI) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "Compositional drain must be blocked");
}
...
fn test_real_compositional_033() {
    ...
    let result = run(input);
    println!(
        "Comp drain 033 (7 accts + CPI) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "Compositional drain must be blocked");
}
...
fn test_real_compositional_034() {
    ...
    let result = run(input);
    println!(
        "Comp drain 034 (8 accts + CPI) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "Compositional drain must be blocked");
}
...
fn test_real_compositional_035() {
    ...
    let result = run(input);
    println!(
        "Comp drain 035 (9 accts + CPI) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "Compositional drain must be blocked");
}
...
fn test_real_compositional_036() {
    ...
    let result = run(input);
    println!(
        "Comp drain 036 (10 accts + CPI) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "Compositional drain must be blocked");
}
...
fn test_real_compositional_037() {
    ...
    let result = run(input);
    println!(
        "Comp drain 037 (11 accts + CPI) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "Compositional drain must be blocked");
}
...
fn test_real_compositional_038() {
    ...
    let result = run(input);
    println!(
        "Comp drain 038 (12 accts + CPI) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "Compositional drain must be blocked");
}
...
fn test_real_compositional_039() {
    ...
    let result = run(input);
    println!(
        "Comp drain 039 (13 accts + CPI) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "Compositional drain must be blocked");
}
...
fn test_real_compositional_040() {
    ...
    let result = run(input);
    println!(
        "Comp drain 040 (14 accts + CPI) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "Compositional drain must be blocked");
}
...
fn test_real_fake_swap_041() {
    ...
    let result = run(input);
    println!(
        "Fake swap 041 (JUPITER_V6) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
        "Fake swap with hidden CPI must be blocked"
    );
}
...
fn test_real_fake_swap_042() {
    ...
    let result = run(input);
    println!(
        "Fake swap 042 (ORCA) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_fake_swap_043() {
    ...
    let result = run(input);
    println!(
        "Fake swap 043 (METEORA) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_fake_swap_044() {
    ...
    let result = run(input);
    println!(
        "Fake swap 044 (JUPITER_V6) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_fake_swap_045() {
    ...
    let result = run(input);
    println!(
        "Fake swap 045 (ORCA) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_fake_swap_046() {
    ...
    let result = run(input);
    println!(
        "Fake swap 046 (METEORA) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_fake_swap_047() {
    ...
    let result = run(input);
    println!(
        "Fake swap 047 (JUPITER_V6) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_fake_swap_048() {
    ...
    let result = run(input);
    println!(
        "Fake swap 048 (ORCA) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_fake_swap_049() {
    ...
    let result = run(input);
    println!(
        "Fake swap 049 (METEORA) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_fake_swap_050() {
    ...
    let result = run(input);
    println!(
        "Fake swap 050 (JUPITER_V6) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_unknown_program_061() {
    ...
    let result = run(input);
    println!(
        "Unknown prog 061 — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_unknown_program_062() {
    ...
    let result = run(input);
    println!(
        "Unknown prog 062 — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_unknown_program_063() {
    ...
    let result = run(input);
    println!(
        "Unknown prog 063 — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_unknown_program_064() {
    ...
    let result = run(input);
    println!(
        "Unknown prog 064 — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_unknown_program_065() {
    ...
    let result = run(input);
    println!(
        "Unknown prog 065 — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_unknown_program_066() {
    ...
    let result = run(input);
    println!(
        "Unknown prog 066 — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_unknown_program_067() {
    ...
    let result = run(input);
    println!(
        "Unknown prog 067 — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_unknown_program_068() {
    ...
    let result = run(input);
    println!(
        "Unknown prog 068 — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_unknown_program_069() {
    ...
    let result = run(input);
    println!(
        "Unknown prog 069 — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_unknown_program_070() {
    ...
    let result = run(input);
    println!(
        "Unknown prog 070 — confidence: {}, unknown: {}",
        result.confidence, result.unknown_protocol
    );
    assert!(
        result.confidence <= 0.55,
...
fn test_real_evasion_071() {
    ...
    let result = run(input);
    println!(
        "Evasion 071 (high evidence) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
        "SetAuthority with high evidence must still be blocked"
    );
}
...
fn test_real_evasion_072() {
    ...
    let result = run(input);
    println!(
        "Evasion 072 (high evidence) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_evasion_073() {
    ...
    let result = run(input);
    println!(
        "Evasion 073 (high evidence) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_evasion_074() {
    ...
    let result = run(input);
    println!(
        "Evasion 074 (high evidence) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_evasion_075() {
    ...
    let result = run(input);
    println!(
        "Evasion 075 (high evidence) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_evasion_076() {
    ...
    let result = run(input);
    println!(
        "Evasion 076 (high evidence) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_evasion_077() {
    ...
    let result = run(input);
    println!(
        "Evasion 077 (high evidence) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_evasion_078() {
    ...
    let result = run(input);
    println!(
        "Evasion 078 (high evidence) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_evasion_079() {
    ...
    let result = run(input);
    println!(
        "Evasion 079 (high evidence) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_evasion_080() {
    ...
    let result = run(input);
    println!(
        "Evasion 080 (high evidence) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_policy_bypass_081() {
    let input = make(SPL_TOKEN, "06", &[A1, A2, A3], &[], WalletProfile::Treasury);
    let result = run(input);
    println!(
        "Policy bypass 081 (Treasury) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
        "SetAuthority must be blocked regardless of profile"
    );
}
...
fn test_real_policy_bypass_082() {
    ...
    let result = run(input);
    println!(
        "Policy bypass 082 (TradingBot) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_policy_bypass_083() {
    let input = make(SPL_TOKEN, "06", &[A1, A2, A3], &[], WalletProfile::Gaming);
    let result = run(input);
    println!(
        "Policy bypass 083 (Gaming) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_policy_bypass_084() {
    ...
    let result = run(input);
    println!(
        "Policy bypass 084 (Enterprise) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_policy_bypass_085() {
    ...
    let result = run(input);
    println!(
        "Policy bypass 085 (TradingBot) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_policy_bypass_086() {
    ...
    let result = run(input);
    println!(
        "Policy bypass 086 (Gaming) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_policy_bypass_087() {
    ...
    let result = run(input);
    println!(
        "Policy bypass 087 (Treasury) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_policy_bypass_088() {
    ...
    let result = run(input);
    println!(
        "Policy bypass 088 (Enterprise) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_policy_bypass_089() {
    ...
    let result = run(input);
    println!(
        "Policy bypass 089 (TradingBot) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_policy_bypass_090() {
    ...
    let result = run(input);
    println!(
        "Policy bypass 090 (Gaming) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        !result.approved,
...
fn test_real_edge_091() {
    ...
    let result = run(input);
    println!(
        "Edge 091 (SetAuthority) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
...
fn test_real_edge_092() {
    ...
    let result = run(input);
    println!(
        "Edge 092 (Transfer) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        result.risk_verdict.status == "Clear",
        "Legitimate transfer must not be risk-blocked"
    );
}
...
fn test_real_edge_093() {
    ...
    let result = run(input);
    println!(
        "Edge 093 (CloseAccount) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
...
fn test_real_edge_094() {
    ...
    let result = run(input);
    println!(
        "Edge 094 (SetAuthority) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "SetAuthority must be blocked");
}
...
fn test_real_edge_095() {
    ...
    let result = run(input);
    println!(
        "Edge 095 (Transfer) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        result.risk_verdict.status == "Clear",
...
fn test_real_edge_096() {
    ...
    let result = run(input);
    println!(
        "Edge 096 (CloseAccount) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "CloseAccount must be blocked");
}
...
fn test_real_edge_097() {
    ...
    let result = run(input);
    println!(
        "Edge 097 (SetAuthority) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "SetAuthority must be blocked");
}
...
fn test_real_edge_098() {
    ...
    let result = run(input);
    println!(
        "Edge 098 (Transfer) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(
        result.risk_verdict.status == "Clear",
...
fn test_real_edge_099() {
    ...
    let result = run(input);
    println!(
        "Edge 099 (CloseAccount) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "CloseAccount must be blocked");
}
...
fn test_real_edge_100() {
    ...
    let result = run(input);
    println!(
        "Edge 100 (SetAuthority) — approved: {}, risk: {}",
        result.approved, result.risk_verdict.status
    );
    assert!(!result.approved, "SetAuthority must be blocked");
}
