...
[![Rust Tests](https://img.shields.io/badge/Rust_Tests-1368_passing-brightgreen?style=flat-square)](graphite-core/tests/)
...
# Run 1,368 tests — zero setup (1,378 total; 10 network-dependent tests ignored
...
│   └── tests/                     ← 1,368 tests (unit + adversarial + exploit + RPC trust boundary + live RPC)
│
...
- 1,368 Rust tests passing (1,378 total; 10 network-dependent ignored), 0 failures, 0 clippy warnings — every test has real assertions.
