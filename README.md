...
[![Rust Tests](https://img.shields.io/badge/Rust_Tests-1370_passing-brightgreen?style=flat-square)](graphite-core/tests/)
...
# Run 1,370 tests — zero setup (1,380 total; 10 network-dependent tests ignored
# unless run explicitly with a live RPC)
cargo test --release

# Output (summed across 49 test binaries):
# test result: ok. 1272 passed; 0 failed; 10 ignored
...
│   └── tests/                     ← 1,370 tests (unit + adversarial + exploit + RPC trust boundary + live RPC)
│
...
- 1,370 Rust tests passing (1,380 total; 10 network-dependent ignored), 0 failures, 0 clippy warnings — every test has real assertions.
