...
# Run 1,272 tests — zero setup (1,282 total; 10 network-dependent tests ignored
...
│   └── tests/                     ← 1,272 tests (unit + adversarial + exploit + RPC trust boundary + live RPC)
│
...
- 1,272 Rust tests passing (1,282 total; 10 network-dependent ignored), 0 failures, 0 clippy warnings — every test has real assertions.
