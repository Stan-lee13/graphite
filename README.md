...
[![Rust Tests](https://img.shields.io/badge/Rust_Tests-834_passing-brightgreen?style=flat-square)](graphite-core/tests/)
...
# Run 834 tests — zero setup
cargo test --release

# Output:
# running 834 tests
# test result: ok. 834 passed; 0 failed; 2 ignored
...
│   └── tests/                   ← 834 tests (unit + adversarial + exploit)
│
...
- 834 Rust tests, 0 failures, 0 clippy warnings — every test has real assertions.
