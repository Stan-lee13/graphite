...
[![Rust Tests](https://img.shields.io/badge/Rust_Tests-1384_passing-brightgreen?style=flat-square)](graphite-core/tests/)
...
# Run 1,384 tests — zero setup (1,394 total; 10 network-dependent tests ignored
...
│   └── tests/                     ← 1,384 tests (unit + adversarial + exploit + RPC trust boundary + live RPC)
│
...
- 1,384 Rust tests passing (1,394 total; 10 network-dependent ignored), 0 failures, 0 clippy warnings — every test has real assertions.
